...
document.addEventListener("DOMContentLoaded", function () {
  ...
  try {
    ...
    [
      { id: "display-name", key: "display-name_legstu", formatter: up },
      { id: "display-surname", key: "display-surname_legstu", formatter: up },
      {
        id: "display-birthDate",
        key: "display-birthDate_legstu",
        formatter: formatDateDots,
      },
      { id: "display-pesel", key: "display-pesel_legstu", formatter: up },
      {
        id: "display-dataWydania",
        key: "display-dataWydania_legstu",
        formatter: formatDateDots,
      },
      { id: "display-uczelnia", key: "display-uczelnia_legstu", formatter: up },
      {
        id: "display-albumNumber",
        key: "display-albumNumber_legstu",
        formatter: up,
      },
  ...
  try {
    var albumNumberEl = document.getElementById("albumNumber");
    var savedAlbumNumber = localStorage.getItem("albumNumber");
    if (savedAlbumNumber && albumNumberEl) {
      albumNumberEl.textContent = savedAlbumNumber;
    }
  } catch (e) {}
